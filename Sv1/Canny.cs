...
namespace Sv1
{
    ...
    class Canny 
    {
        ...
        public float[,] FilteredGradientX;
        public float[,] FilteredGradientY;
        public int[,] FilteredImage;
        public float[,] GradientMat;
        public float[,] NotMax;
        public int[,] PostHysteresis;
        int[,] EdgeMatrix;
        public float[,] HighGradients;
        public float[,] LowGradients;
        ...
        /// </summary>
        public Bitmap DispImg(int[,] GreyImage)
        {
            int i, j;
            int W, H;
            W = GreyImage.GetLength(0);
        ...
        {
            GradientMat = new float[Width, Height];
            NotMax = new float[Width, Height];
            PostHysteresis = new int[Width, Height];

            FilteredGradientX = new float[Width, Height];
            FilteredGradientY = new float[Width, Height];
           ...
           // NotMax = GradientMat;
            ...
            HighGradients = new float[Width, Height];
            LowGradients = new float[Width, Height]; ;
